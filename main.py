...
def compile_gif(): #funciton that proceeds the compilation of all the gifs in the input folder
    ...
    print("Make sure that the gifs you want to compile are in the input folder. and if the gifs are labelled corectly, it should just take a bit of the name to work.")
    print("Press enter after writing the name of the file.")
    naming = input()
